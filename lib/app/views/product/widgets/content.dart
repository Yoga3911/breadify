...
class ContentProduct extends StatelessWidget {
  const ContentProduct({Key? key, required this.storeModel}) : super(key: key);
          ...
          Row(
            ...
            children: [
              FutureBuilder<UserModel>(
                future: userProvider.getUserById(storeModel.userId),
                builder: (_, user) {
                  ...
                  return GestureDetector(
                    onTap: () => Navigator.pushNamed(
                      ...
                      arguments: {
                        ...
                        "open": storeModel.open,
                        "close": storeModel.close,
                        "seller_id": storeModel.userId,
                      },
                    ),
                    child: Row(
                      children: [
